...
SELECT 'A-41/2-01', 'A-41/2-01', 'Amoladora (4 1/2")', 'Hamilton', 'Hamilton', 'Disponible', id, 'Amoladoras'
...
-- Tool: A-41/2-O2
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'A-41/2-O2', 'A-41/2-O2', 'Amoladora (4 1/2")', 'Skil', 'Skil', 'Disponible', id, 'Amoladoras'
...
-- Tool: A-41/2-O3
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'A-41/2-O3', 'A-41/2-O3', 'Amoladora (4 1/2")', 'Hamilton', 'Hamilton', 'Disponible', id, 'Amoladoras'
...
-- Tool: A-41/2-O4
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'A-41/2-O4', 'A-41/2-O4', 'Amoladora (4 1/2")', 'Black&Decker', 'Black&Decker', 'Disponible', id, 'Amoladoras'
...
-- Tool: A-7-01
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'A-7-01', 'A-7-01', 'Amoladora (7")', 'Total', 'Total', 'Disponible', id, 'Amoladoras'
...
-- Tool: A-7-02
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'A-7-02', 'A-7-02', 'Amoladora (7")', 'Total', 'Total', 'Disponible', id, 'Amoladoras'
FROM public.obras WHERE name = 'COUNTRY CANTARES' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: ANC-01
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'ANC-01', 'ANC-01', 'Cuerpo Andamio 1', '', '', 'Disponible', id, 'Otros'
FROM public.obras WHERE name = 'COUNTRY CANTARES' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: ANC-02
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'ANC-02', 'ANC-02', 'Cuerpo Andamio 2', '', '', 'Disponible', id, 'Otros'
FROM public.obras WHERE name = 'COUNTRY CANTARES' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: ANC-03
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'ANC-03', 'ANC-03', 'Cuerpo Andamio 3', '', '', 'Disponible', id, 'Otros'
FROM public.obras WHERE name = 'COUNTRY CANTARES' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: ARN-01
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'ARN-01', 'ARN-01', 'Arnés', 'Amarillo', 'Amarillo', 'Disponible', id, 'Elementos de seguridad'
FROM public.obras WHERE name = 'COUNTRY CANTARES' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: ESC-03
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'ESC-03', 'ESC-03', 'Escalera 3', 'Cant peldaños', 'Cant peldaños', 'Disponible', id, 'Escaleras'
FROM public.obras WHERE name = 'DOMUS' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: ESC-04
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'ESC-04', 'ESC-04', 'Escalera 4', 'Cant peldaños', 'Cant peldaños', 'Disponible', id, 'Escaleras'
FROM public.obras WHERE name = 'DOMUS' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: ESC-05
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'ESC-05', 'ESC-05', 'Escalera 5', 'Cant peldaños', 'Cant peldaños', 'Disponible', id, 'Escaleras'
FROM public.obras WHERE name = 'DOMUS' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: ESC01
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'ESC01', 'ESC01', 'Escalera 1', 'Cant peldaños', 'Cant peldaños', 'Disponible', id, 'Escaleras'
FROM public.obras WHERE name = 'SHELL OASIS' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: ESC02
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'ESC02', 'ESC02', 'Escalera 2', 'Cant peldaños', 'Cant peldaños', 'Disponible', id, 'Escaleras'
FROM public.obras WHERE name = 'SHELL OASIS' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: GA-01
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'GA-01', 'GA-01', 'Garrafa', 'Negra', 'Negra', 'Disponible', id, 'Otros'
FROM public.obras WHERE name = 'COUNTRY CANTARES' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: GA-02
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'GA-02', 'GA-02', 'Garrafa', 'Roja', 'Roja', 'Disponible', id, 'Otros'
FROM public.obras WHERE name = 'COUNTRY CANTARES' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: PI-01
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'PI-01', 'PI-01', 'Pinza de identar', '', '', 'Disponible', id, 'Otros'
FROM public.obras WHERE name = 'COUNTRY CANTARES' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: PI-02
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'PI-02', 'PI-02', 'Pinza de identar', '', '', 'Disponible', id, 'Otros'
FROM public.obras WHERE name = 'COUNTRY CANTARES' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: RES-20-01
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'RES-20-01', 'RES-20-01', 'Resorte', '20mm (3/4")', '20mm (3/4")', 'Disponible', id, 'Otros'
FROM public.obras WHERE name = 'SHELL OASIS' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: RES-22-01
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'RES-22-01', 'RES-22-01', 'Resorte', '22mm (7/8")', '22mm (7/8")', 'Disponible', id, 'Otros'
FROM public.obras WHERE name = 'SHELL OASIS' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: RES-25-01
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'RES-25-01', 'RES-25-01', 'Resorte', '25mm (1")', '25mm (1")', 'Disponible', id, 'Otros'
FROM public.obras WHERE name = 'SHELL OASIS' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: RTD01
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'RTD01', 'RTD01', 'Rotomartillo demoledor', 'Barovo', 'Barovo', 'Disponible', id, 'Taladros'
FROM public.obras WHERE name = 'SHELL OASIS' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: RTP-01
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'RTP-01', 'RTP-01', 'Rotomartillo percutor', 'Barovo', 'Barovo', 'Disponible', id, 'Taladros'
FROM public.obras WHERE name = 'COUNTRY CANTARES' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: TCC-01
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'TCC-01', 'TCC-01', 'Tijera corta cable', '', '', 'Disponible', id, 'Otros'
FROM public.obras WHERE name = 'COUNTRY CANTARES' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: TCC-02
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'TCC-02', 'TCC-02', 'Tijera corta cable', '', '', 'Disponible', id, 'Otros'
FROM public.obras WHERE name = 'COUNTRY CANTARES' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: TP-01
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'TP-01', 'TP-01', 'Taladro percutor', 'Total', 'Total', 'Disponible', id, 'Taladros'
FROM public.obras WHERE name = 'DOMUS' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: TP-02
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'TP-02', 'TP-02', 'Taladro chico', 'Barovo', 'Barovo', 'Disponible', id, 'Taladros'
FROM public.obras WHERE name = 'QUALITY BARRIO NORTE' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: TRP-01
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'TRP-01', 'TRP-01', 'Taladro rotopercutor', 'Dewalt', 'Dewalt', 'Disponible', id, 'Taladros'
FROM public.obras WHERE name = 'DOMUS' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: TRP-02
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'TRP-02', 'TRP-02', 'Taladro rotopercutor', 'Barovo', 'Barovo', 'Disponible', id, 'Taladros'
FROM public.obras WHERE name = 'QUALITY BARRIO NORTE' LIMIT 1
ON CONFLICT (code) DO UPDATE SET 
  name = EXCLUDED.name,
  brand = EXCLUDED.brand,
...
-- Tool: ESC-06
INSERT INTO public.herramientas (code, qr_code, name, brand, model, status, current_obra_id, category)
SELECT 'ESC-06', 'ESC-06', 'Escalera', 'Cant peldaños', 'Cant peldaños', 'Disponible', id, 'Escaleras'
