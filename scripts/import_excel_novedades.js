...
async function main() {
  ...
  // Cargar lista de empleados existentes para vincular IDs
  ...
  // Fila 0 es título, fila 1 es encabezado, datos empiezan en fila 2
  for (let i = 2; i < rawRows.length; i++) {
    ...
    recordsToInsert.push({
      ...
      observaciones: obs || (seJustifica ? `Se justifica: ${seJustifica}` : null),
  ...
  console.log(`\n✅ ¡Importación completada con éxito! Total registros ingresados: ${inserted}`);
}
