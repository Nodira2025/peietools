-- =========================================================================
-- MIGRACIÓN DE ACTUALIZACIÓN INTEGRAL: LOGÍSTICA, PERSONAL Y GEOLOCALIZACIÓN
-- =========================================================================

-- 1. Agregar columna de categoría en herramientas
...
-- 2.5 Agregar columna photo_url en obras
ALTER TABLE public.obras 
ADD COLUMN IF NOT EXISTS photo_url TEXT;

-- 3. Crear tabla para registro de avance fotográfico de obras
