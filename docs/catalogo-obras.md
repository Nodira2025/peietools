...
**Todas las obras** usa un informe tabular «Distribución de herramientas por obra»: filas numeradas con nombre y código de cada herramienta, celdas agrupadas para obra y cantidad, obras vacías con cero y total general. Tiene título centrado PEIE Tools, fecha, cabecera oscura y bordes finos. Todas las obras se incluyen en una única página continua cuyo alto se ajusta al contenido, sin saltos ni encabezados repetidos. El JPEG también es una sola imagen. PDF y JPEG comparten esta tabla. Esta modalidad consulta únicamente herramientas y no descarga fotos ni personal.

La exportación individual de cada obra tiene páginas de trabajadores y herramientas, con logo y colores PEIE, nombre, ubicación, responsable, estado, fecha de generación y totales. El personal incluye foto, nombre y el rol registrado en `specialty`; las herramientas incluyen foto, nombre, código, marca y estado. Los trabajadores son los activos asignados y las herramientas se consultan por su ubicación actual.
