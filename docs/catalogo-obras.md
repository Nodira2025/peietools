...
**Todas las obras** usa un informe tabular «Distribución de herramientas por obra»: filas numeradas con nombre y código de cada herramienta, celdas agrupadas para obra y cantidad, obras vacías con cero y total general. Tiene título centrado PEIE Tools, fecha, cabecera oscura y bordes finos. Las obras extensas continúan en la página siguiente con su nombre y conteo identificados. PDF y JPEG comparten esta tabla. Esta modalidad consulta únicamente herramientas y no descarga fotos ni personal.
